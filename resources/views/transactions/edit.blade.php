                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('transactions.update', $transaction->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="date" id="transaction_date" class="form-control" name="transaction_date"
                                                    placeholder="Tanggal" value="{{ $transaction->transaction_date}}">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="number" id="amount" class="form-control" name="amount"
                                                    placeholder="Jumlah transaksi" value="{{ number_format($transaction->amount, 0, ',','.') }}">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="description" class="form-control" name="description"
                                                    placeholder="pendapatan dari jualan" value="{{ $transaction->description }}">
                                            </div>
